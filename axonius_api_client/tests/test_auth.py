...
class TestAuth(object):
    ...
    def test_valid_creds(self, api_url, creds):
    ...
    @pytest.mark.needs_key_creds
    def test_logout(self, api_url, creds):
    ...
    @pytest.mark.needs_key_creds
    def test_login_already_logged_in(self, api_url, creds):
    ...
    @pytest.mark.needs_key_creds
    def test_logout_not_logged_in(self, api_url, creds):
    ...
    def test_invalid_creds(self, api_url, creds):
        """Test str/repr has URL."""
        http = axonapi.Http(url=api_url, certwarn=False)
    ...
    def test_http_lock_fail(self, api_url, creds):
        """Test using an http client from another authmethod throws exc."""
        http = axonapi.Http(url=api_url)
        auth = creds["cls"](http=http, **creds["creds"])
