    ...
    def test_set_revert(self, api_adapters, request, monkeypatch):
        ...
        with runner.isolated_filesystem():
            ...
            update_args = [
                ...
                "--id",
                f"{cnx_id}",
                "--active" if value_update else "--no-active",
                "--export-format",
                "json",
            ]
            ...
            revert_args = [
                ...
                "--id",
                f"{cnx_id}",
                "--active" if value_orig else "--no-active",
                "--export-format",
                "json",
            ]
