# -*- coding: utf-8 -*-
"""Test suite for axonius_api_client.models."""
...
class TestFindAdapter(object):
    """Test axonius_api_client.models.find_adapter."""
    ...
    def test_valid(self, adapter, known_names):
        ...
        response = axonius_api_client.models.find_adapter(
    ...
    def test_invalid(self, adapter):
        ...
        with pytest.raises(axonius_api_client.exceptions.UnknownAdapterName):
            axonius_api_client.models.find_adapter(
                name=adapter, known_names=["other_known_adapter"]
            )


class TestFindFieldGeneric(object):
    """Test axonius_api_client.models.find_field with generic fields."""
    ...
    def test_valid(self, field, fields):
        ...
        response = axonius_api_client.models.find_field(
    ...
    def test_invalid(self):
        ...
        with pytest.raises(axonius_api_client.exceptions.UnknownFieldName):
            axonius_api_client.models.find_field(
...
class TestFindFieldAdapter(object):
    """Test axonius_api_client.models.find_field with adapter fields."""
...
class TestValidateFields(object):
    """Test axonius_api_client.models.validate_fields."""
    ...
    def test__validate_fields_valid(self, fields):
        ...
        response = axonius_api_client.models.validate_fields(
    ...
    def test__validate_fields_invalid_field(self):
        ...
        with pytest.raises(axonius_api_client.exceptions.UnknownFieldName):
            axonius_api_client.models.validate_fields(
