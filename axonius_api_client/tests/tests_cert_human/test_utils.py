...
def test_type_str():
    exp = (
        "type=<class 'str'>, length=50, value='xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx...snip...'"
    )
    data = utils.type_str(value="x" * 50)
    assert data == exp


def test_human_key_value():
    exp = "  - TEST                        : [1, 2, 3]"
