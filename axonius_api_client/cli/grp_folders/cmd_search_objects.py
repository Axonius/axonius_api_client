...
from .grp_options import OPTS_SEARCH

OPTIONS = [*AUTH, *OPTS_SEARCH]


@click.command(name="search-objects", context_settings=CONTEXT_SETTINGS)
@add_options(OPTIONS)
@click.pass_context
def cmd(
    ctx,
    ...
    **kwargs,
    ...
    with ctx.obj.exc_wrap(wraperror=ctx.obj.wraperror):
        folder, objs = apiobj.search_objects(echo=echo, **kwargs)
