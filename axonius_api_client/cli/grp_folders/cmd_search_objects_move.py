...
from .grp_options import OPTS_SEARCH_MOVE

OPTIONS = [*AUTH, *OPTS_SEARCH_MOVE]


@click.command(name="search-objects-move", context_settings=CONTEXT_SETTINGS)
@add_options(OPTIONS)
@click.pass_context
def cmd(
    ctx,
    ...
    **kwargs,
    ...
    """Search for objects in a folder and move them."""
    ...
    with ctx.obj.exc_wrap(wraperror=ctx.obj.wraperror):
        folder, objs = apiobj.search_objects_move(echo=echo, **kwargs)
