...
from .grp_options import OPTS_SEARCH_DELETE

OPTIONS = [*AUTH, *OPTS_SEARCH_DELETE]


@click.command(name="search-objects-delete", context_settings=CONTEXT_SETTINGS)
@add_options(OPTIONS)
@click.pass_context
def cmd(
    ctx,
    ...
    **kwargs,
    ...
    with ctx.obj.exc_wrap(wraperror=ctx.obj.wraperror):
        folder, objs, delete_objs = apiobj.search_objects_delete(echo=echo, **kwargs)
