...
SSL_UPDATE = [
    click.option(
        ...
        "-cf",
        "cert_file",
        help="Certificate file to install on the server. (Must be in PEM format.)",
        default="-",
        type=click.File(mode="r"),
        show_envvar=True,
        show_default=True,
    ...
    click.option(
        ...
        "-kf",
        "key_file",
        help="Key file to install on the server. (Must be in PEM format.)",
        default="-",
        type=click.File(mode="r"),
        show_envvar=True,
        show_default=True,
    ...
    click.option(
        ...
        show_envvar=True,
        show_default=True,
        help="Hostname of the Axonius server.",
    ),
    click.option(
        "--enabled/--disabled",
        "-e/-d",
        "enabled",
        default=True,
        help="Should the certificate be enabled.",
        show_envvar=True,
        show_default=True,
        is_flag=True,
        hidden=False,
    ...
    click.option(
        ...
        "-p",
        "passphrase",
        help="Passphrase needed to unlock the key file.",
        metavar="PASSPHRASE",
        # prompt="Passphrase of key file",
