...
@click.command(name="get-by-username", context_settings=cli_constants.CONTEXT_SETTINGS)
@options.OPT_URL
@options.OPT_KEY
@options.OPT_SECRET
...
def cmd(ctx, url, key, secret, **kwargs):
    """Get assets with matching usernames."""
    grp_common.get_by_cmd(ctx=ctx, method="get_by_username", **kwargs)
