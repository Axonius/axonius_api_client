...
from . import routers, mixins, utils
from .. import tools, constants, exceptions, models


class UserDeviceMixins(models.UserDeviceModel):
...
class Users(mixins.ApiMixins, UserDeviceMixins):
...
class Devices(mixins.ApiMixins, UserDeviceMixins):
