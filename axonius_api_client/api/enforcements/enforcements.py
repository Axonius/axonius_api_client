...
class Enforcements(ApiModel):
    ...
    ) -> json_api.enforcements.SET_UNION:
    ...
    def get_action_types(self) -> json_api.enforcements.ACTION_TYPES:
        """Get all Action Types that can be used when adding an Action to an Enforcement Set."""
        return self._get_action_types()

    def find_set(self, value: str, full: bool = True) -> json_api.enforcements.SET_BOTH:
    ...
    def find_action_type(self, value: str) -> json_api.enforcements.ACTION_TYPE:
    ...
    ) -> json_api.enforcements.SET_FULL:
    ...
    def _set_has_running_task(self, name: str) -> json_api.generic.BoolValue:
        ...
        Args:
            name: name of Enforcement Set
        """
        api_endpoint = ApiEndpoints.enforcements.set_has_running_task
    ...
    def _run_set(
        ...
        """
        api_endpoint = ApiEndpoints.enforcements.run_set
    ...
    ) -> json_api.enforcements.SETS_BASIC:
    ...
    def _get_sets_gen(self, full: bool = False) -> json_api.enforcements.SET_GEN:
    ...
    def _get_set_by_uuid(self, uuid: str) -> json_api.enforcements.SET_FULL:
        ...
        """
        api_endpoint = ApiEndpoints.enforcements.get_set_by_uuid
        return api_endpoint.perform_request(client=self.CLIENT, uuid=uuid)

    def _get_action_types(self) -> json_api.enforcements.ACTION_TYPES:
    ...
    ) -> json_api.enforcements.TASKS_BASIC:
    ...
    def _get_tasks_gen(self, uuid: str, full: bool = True) -> json_api.enforcements.TASK_GEN:
    ...
    def _get_task_by_uuid(self, uuid: str) -> json_api.enforcements.TASK_FULL:
        """Direct API method to a task for an Enforcement Set in 'full' format.

        Args:
            uuid: uuid of task
        """
        api_endpoint = ApiEndpoints.enforcements.get_task_by_uuid
        return api_endpoint.perform_request(client=self.CLIENT, uuid=uuid)
