...
* :doc:`grp_objects_saved_query_cmds/cmd_add` to add a saved query for device assets.
* :doc:`grp_objects_saved_query_cmds/cmd_delete` to delete an existing saved query for
  device assets.
* :doc:`grp_objects_saved_query_cmds/cmd_get` to get all saved queries for device assets.
